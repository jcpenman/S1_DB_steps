...
*
*
*      This package is to only be used for DevNet while 
*      the EDM functionality is switched off
*
*     If asked to make changes to this package please check out
*    
*     http://172.26.33.82:18080/svn/stepsV9/steps103/trunk/Database/steps/sgas/packages/SHORTENED_APPLICATION_WEB_ST/ORIG_CODE/SHORTENED_APPLICATION_WEB_ST.pks
*
*    and then run this back in to DevNet when complete
*
*    http://172.26.33.82:18080/svn/stepsV9/steps103/trunk/Database/steps/sgas/packages/SHORTENED_APPLICATION_WEB_ST/NEW CODE/SHORTENED_APPLICATION_WEB_ST.pks
*
*
*   the only difference is FUNCTION get_eistream_record is commented out for DevNet
-------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
  IS
--
...
( rd_object_id raw_data.OBJECT_ID%TYPE,
  ...
  rd_top_option raw_data.top_option%TYPE,
...
FUNCTION get_shwap(p_object_id IN EDM_IMAGES.object_id%TYPE,
                    ...
                    p_top_option IN COMPLETED_SHWAP.top_option%TYPE) RETURN varchar2 ;
--
