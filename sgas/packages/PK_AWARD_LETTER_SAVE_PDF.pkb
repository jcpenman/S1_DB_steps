...
AS
   ...
   PROCEDURE Load_DSA_BLOB_From_File (l_file_name                IN     VARCHAR2,
                                  l_dsa_award_id        IN     NUMBER,
                                  l_DIRECTORY_NAME           IN     VARCHAR2,
                                  error_boolean                 OUT VARCHAR2,
                                  ERROR_TEXT                    OUT VARCHAR2)
   IS
   ...
   BEGIN
     ...
     UPDATE DSA_AWARD_NOTICE
      SET AWARD_PDF = EMPTY_BLOB ()
      WHERE DSA_AN_ID = l_dsa_award_id
       RETURNING DSA_AWARD_NOTICE.award_PDF
           INTO p_dest_loc;
